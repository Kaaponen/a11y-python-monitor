...
class ScannerLoggerAdapter(logging.LoggerAdapter):
    ...
    def scan_started(self, url: str, scan_id: str) -> None:
        ...
        self.info(
            "Scan started",
            extra={"event": "scan_started", "url": url, "scan_id": scan_id},
        )

    def scan_completed(
        self, url: str, scan_id: str, duration: float, violation_count: int
    ) -> None:
    ...
    def scan_failed(
        self, url: str, scan_id: str, error: Exception, duration: float
    ) -> None:
    ...
    def report_generated(
        self, report_type: str, file_path: str, size_bytes: int
    ) -> None:
