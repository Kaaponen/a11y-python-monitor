...
async def get_cached_scan_result(url: str, scan_type: str = "axe") -> Optional[Dict[str, Any]]:
...
async def cache_scan_result(url: str, result: Dict[str, Any], scan_type: str = "axe", ttl: int = 3600) -> bool:
