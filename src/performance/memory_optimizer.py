                ...
                if memory_mb > self.threshold_mb:
                    ...
                    for callback in self.callbacks:
                        try:
                            ...
                            logger.error(
                                "Memory callback failed", extra={"error": str(e)}
                            )
...
class ObjectTracker:
    ...
    def track_object(self, obj: Any, obj_type: str = None):
        ...
        try:
            # Luo weak reference
            self.tracked_objects[obj_id] = weakref.ref(
                obj, self._cleanup_callback(obj_id)
            )
...
class MemoryOptimizer:
    ...
    def _on_memory_threshold(self, memory_mb: float):
        ...
        logger.warning(
            ...
            extra={"memory_mb": memory_mb, "threshold_mb": self.memory_limit_mb},
        )
    ...
    def get_memory_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recent_cleanups": (
                self.cleanup_history[-5:] if self.cleanup_history else []
            ),
        }
