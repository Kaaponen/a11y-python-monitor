...
class CacheManager:
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            logger.info(
                "Connected to Redis successfully", extra={"redis_url": self.redis_url}
            )
    ...
    def _serialize_data(self, data: Any) -> bytes:
        ...
        try:
            ...
            logger.error("Data serialization failed", extra={"error": str(e)})
            raise
    ...
    def _deserialize_data(self, data: bytes) -> Any:
        ...
        try:
            ...
            logger.error("Data deserialization failed", extra={"error": str(e)})
            raise
    ...
    async def get(self, key: str) -> Optional[Any]:
        ...
        try:
            ...
            logger.debug("Cache hit", extra={"key": key, "data_size": len(data)})
    ...
    async def set(self, key: str, value: Any, ttl: Optional[int] = None) -> bool:
        ...
        try:
            ...
            logger.debug(
                ...
                extra={"key": key, "ttl": ttl, "data_size": len(serialized_data)},
            )
    ...
    async def exists(self, key: str) -> bool:
        ...
        try:
            ...
            logger.error(
                "Cache exists check failed", extra={"key": key, "error": str(e)}
            )
            return False
    ...
    async def clear(self, pattern: str = "*") -> int:
        ...
        try:
            ...
            if keys:
                ...
                logger.info(
                    "Cache cleared", extra={"pattern": pattern, "deleted_keys": deleted}
                )
                return deleted
            return 0
            ...
            logger.error(
                "Cache clear failed", extra={"pattern": pattern, "error": str(e)}
            )
            return 0
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            ...
            try:
                ...
                logger.warning(
                    f"Cache get failed, falling back to function execution: {e}"
                )
