...
class APIRateLimiter:
    ...
    def __init__(self, 
        ...
        logger.info("APIRateLimiter initialized", extra={
    ...
    def _is_client_blocked(self, client_id: str, current_time: float) -> Tuple[bool, Optional[int]]:
        ...
        if current_time >= block_info['expires_at']:
            ...
            logger.info("Client unblocked", extra={
                "client_id": client_id,
    ...
    def _block_client(self, client_id: str, current_time: float, reason: str, duration: int = 300):
        ...
        logger.warning("Client blocked", extra={
            "client_id": client_id,
            "reason": reason,
            "duration": duration
        })
    ...
    async def check_rate_limit(self, 
                               client_id: str, 
                               endpoint: str = "default") -> Dict[str, Any]:
        """
    ...
    async def reset_client(self, client_id: str) -> bool:
        ...
        try:
            ...
            logger.error("Failed to reset client rate limit", extra={
                "client_id": client_id,
                "error": str(e)
            })
            return False
...
class AdaptiveRateLimiter:
    ...
    async def adjust_rate_limit(self) -> int:
        ...
        if new_limit != self.current_limit:
            ...
            logger.info("Rate limit adjusted", extra={
                "old_limit": self.current_limit,
                "new_limit": new_limit,
                "cpu_load": cpu_load,
                "memory_load": memory_load
