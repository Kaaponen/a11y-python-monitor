...
from src.utils.health_monitor import HealthMonitor, ScanMetrics, SystemMetrics, get_health_monitor
...
class TestHealthMonitor:
    ...
    def test_collect_system_metrics(self, mock_psutil):
        ...
        mock_psutil.virtual_memory.return_value = MagicMock(percent=65.0, used=1073741824)  # 1GB
    ...
    def test_start_stop_monitoring(self, mock_psutil):
        ...
        mock_psutil.virtual_memory.return_value = MagicMock(percent=60.0, used=1073741824)
